...
package com.example.yuanping.weconnected.login.com.sina.weibo.sdk.openapi.legacy;

import android.content.Context;
import android.util.Log;

import com.example.yuanping.weconnected.login.com.sina.weibo.sdk.openapi.AbsOpenAPI;
...
public class FriendshipsAPI extends AbsOpenAPI {
    ...
    public void friendsIds(long uid, int count, int cursor, RequestListener listener) {
        ...
        //@HusterYP
        Log.d("@HusterYP", String.valueOf("URL..."+SERVER_URL_PRIX + "/friends/ids.json"+"...UID..."+uid+"...COUNT..."+count));
